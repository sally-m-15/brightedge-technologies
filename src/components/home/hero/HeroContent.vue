<template>
    ...
    >
    <span
    class="h-2 w-2 rounded-full bg-gold bg-primary"
    ></span>
  Intelligent Lighting Systems
</p>
<h1 class="flex flex-col text-8xl font-bold text-text-light tracking-[2px]">
    Light that
    <span>
...
<p class=" text-md w-110 tracking-widest  text-text-secondary-light">
  ...
  GET A CONSULTATION
            ...
            <router-link :to="{name: 'products'}">
                    ...
                    <BaseButton iconClass="text-text-light"
class="bg-bg-dark text-text-light px-8! rounded-xl hover:text-primary-hover  border! border-border-light! hover:border-primary!">
  VIEW PROJECTS
</BaseButton>
            </router-link>
